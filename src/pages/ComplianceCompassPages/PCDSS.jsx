...
function PCDSS() {
    ...
    return (
        <>
            ...
            <HeroSection
                title="Achieve Seamless PCI DSS Compliance with Our Expert Guidance"
                subtitle="Understanding Your Unique Compliance Journey"
                description1="Welcome to Ampcus Cyber, your trusted partner in achieving and maintaining Payment Card Industry Data Security Standard (PCI DSS) compliance. As a PCI Qualified Security Assessor (QSA), we take pride in empowering businesses to secure payment card data and build a robust defense against cyber threats."
                description2="Navigating the complexities of PCI DSS compliance can be a challenging endeavor. At Ampcus Cyber, we recognize that each business is unique, with distinct processes and requirements. Our seasoned team of PCI QSA professionals is dedicated to understanding your specific needs and tailoring compliance solutions that seamlessly integrate with your operations."
                imageSrc="/image/pci"
